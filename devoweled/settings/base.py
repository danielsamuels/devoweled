"""
Production settings for devoweled project.
...
MEDIA_ROOT = "/var/www/devoweled_media"
...
STATIC_ROOT = "/var/www/devoweled_static"
...
ROOT_URLCONF = "devoweled.urls"

WSGI_APPLICATION = "devoweled.wsgi.application"
...
CACHE_MIDDLEWARE_KEY_PREFIX = "devoweled"
...
SECRET_KEY = "#+(ld_*q@+o4#r^%8ylw&_4g19uyteqo)b&z@v21^@)t$@(gdt"
