...
var staticFolder = 'devoweled/static/';
var templateFolder = 'devoweled/templates/';
...
gulp.task('bowerFiles', function() {
    gulp.src([
        ...
        .pipe(gulp.dest('devoweled/static/js/vendor/'));


    gulp.src('bower_components/foundation/js/foundation/*')
        .pipe(gulp.dest('devoweled/static/js/vendor/foundation/'));
    ...
    gulp.src([
        ...
        .pipe(gulp.dest('devoweled/static/scss/'));
